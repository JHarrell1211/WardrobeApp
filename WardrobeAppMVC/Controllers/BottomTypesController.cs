...
namespace WardrobeAppMVC.Controllers
{
    public class BottomTypesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "BottomTypeID,BottomType1")] BottomType bottomType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "BottomTypeID,BottomType1")] BottomType bottomType)
        {
            if (ModelState.IsValid)
            {
