...
namespace WardrobeAppMVC.Controllers
{
    public class ShoesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ShoeID,ShoeName,ShoeTypeID,ShoeImage,ColorID,OccasionID,SeasonID")] Sho sho)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ShoeID,ShoeName,ShoeTypeID,ShoeImage,ColorID,OccasionID,SeasonID")] Sho sho)
        {
            if (ModelState.IsValid)
            {
