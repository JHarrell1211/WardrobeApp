...
namespace WardrobeAppMVC.Controllers
{
    public class AccessoriesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "AccessoryID,AccessoryName,AccessoryTypeID,AccessoryImage,ColorID,OccasionID,SeasonID")] Accessory accessory)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "AccessoryID,AccessoryName,AccessoryTypeID,AccessoryImage,ColorID,OccasionID,SeasonID")] Accessory accessory)
        {
            if (ModelState.IsValid)
            {
